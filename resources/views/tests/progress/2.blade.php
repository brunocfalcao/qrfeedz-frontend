...
<body class="flex flex-col bg-white mx-3 my-3 overflow-y-hidden">
    ...
    <!-- /header section -->
    <!-- content section -->
    <main class="bg-white flex-grow w-full overflow-y-auto rounded-t-[2rem] mt-[-2rem] burger-bg">
        <!-- content main area -->
        <div class="text-center py-2 flex flex-col items-center justify-center h-full border-4 border-[#DA291C] burger-bg">
            <div class="w-[90%]">
