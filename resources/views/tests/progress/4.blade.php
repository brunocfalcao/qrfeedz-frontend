...
<body class="flex flex-col bg-white mx-3 my-3 overflow-y-hidden">
    ...
    <!-- header section -->
    <header class="bg-[#DA291C] flex-none w-full rounded-t-[2rem] h-sm:h-32 h-md:h-40">
        <div class="text-center text-white font-bold py-2 flex items-center justify-center h-full">

            <!-- header content section -->
            <div class="-mt-[2rem] h-md:-mt-[2.5rem] text-center">
                <div class="w-12 w-12 mx-auto text-[#FFC72C]">
                    <!-- logo -->
    ...
    <main class="bg-white flex-grow w-full overflow-y-auto rounded-t-[2rem] mt-[-2rem] content-bg">
        ...
        <div class="text-center py-2 flex flex-col items-center justify-center h-full border-4 border-[#DA291C] content-bg">
            <div class="w-[90%]">
                <p class="text-xl font-bold px-3 pb-4 h-md:pb-8">Choose an option</p>
                <div class="flex flex-col gap-12">
                    <button class="w-full h-[3rem] h-md:h-[5rem] bg-[#FFBC0d] rounded-r-[2rem] rounded-tl-[2rem] flex justify-between items-center">
                        <div class="pl-2 pr-3 h-md:px-3">
                            <div class="h-8 w-8 h-md:h-14 h-md:w-14 rounded-tl-full rounded-r-full bg-white text-[#DA291C] flex items-center justify-center">
                                <svg class="h-5 w-5 h-md:w-7 h-md:h-7" viewBox="0 0 15 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="text-[#FFBC0d] font-bold h-md:text-xl text-white w-full text-left">Give feedback</div>
