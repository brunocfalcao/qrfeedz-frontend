...
<head>
    ...
    <!--favicon icon-->
    <link rel="icon" href="/site/img/favicon.png" type="image/png" sizes="16x16">

    <!--google fonts-->
    <link href="/site/https://fonts.googleapis.com/css?family=Montserrat:400,500,600,700%7COpen+Sans&display=swap"
          rel="stylesheet">
...
<header class="header">
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-transparent">
        <div class="container">
            <a class="navbar-brand" href="/site/index.html"><img src="/site/img/logo-white-1x.png" width="120" alt="logo"
                                                           class="img-fluid"></a>
            ...
            <div class="collapse navbar-collapse main-menu justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link page-scroll dropdown-toggle" href="/site/#" id="navbarDropdownHome" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Home
                        </a>
                        <div class="dropdown-menu submenu" aria-labelledby="navbarDropdownHome">
                            <a class="dropdown-item" href="/site/index.html">Demo Template 1</a>
                            <a class="dropdown-item" href="/site/index-2.html">Demo Template 2</a>
                            <a class="dropdown-item" href="/site/index-3.html">Demo Template 3</a>
                            <a class="dropdown-item" href="/site/index-4.html">Demo Template 4</a>
                            <a class="dropdown-item" href="/site/index-5.html">Demo Template 5</a>
                            <a class="dropdown-item" href="/site/index-6.html">Demo Template 6</a>
                            <a class="dropdown-item" href="/site/index-7.html">Demo Template 7</a>
                            <a class="dropdown-item" href="/site/index-8.html">Demo Template 8 <span class="badge text-bg-warning">New</span></a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="/site/#about">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="/site/#features">Features</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="/site/#pricing">Pricing</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="/site/#screenshots">Screenshots</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link page-scroll dropdown-toggle" href="/site/#" id="navbarDropdownPage" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Pages
                        </a>
                        <div class="dropdown-menu submenu" aria-labelledby="navbarDropdownPage">
                            <a class="dropdown-item" href="/site/basic-login.html">Login Page 1</a>
                            <a class="dropdown-item" href="/site/login.html">Login Page 2</a>
                            <a class="dropdown-item" href="/site/basic-sign-up.html">Signup Page 1</a>
                            <a class="dropdown-item" href="/site/sign-up.html">Signup Page 2</a>
                            <a class="dropdown-item" href="/site/password-reset.html">Password Reset</a>
                            <a class="dropdown-item" href="/site/change-password.html">Change Password</a>
                            <a class="dropdown-item" href="/site/download.html">Download Page</a>
                            <a class="dropdown-item" href="/site/review.html">Review Page</a>
                            <a class="dropdown-item" href="/site/faq.html">FAQ Page</a>
                            <a class="dropdown-item" href="/site/404.html">404 Page</a>
                            <a class="dropdown-item" href="/site/coming-soon.html">Coming Soon</a>
                            <a class="dropdown-item" href="/site/thank-you.html">Thank You</a>
                            <a class="dropdown-item" href="/site/team.html">Team Page <span class="badge text-bg-danger badge-pill ms-2">New</span></a>
                            <a class="dropdown-item" href="/site/team-single.html">Team Single <span class="badge text-bg-danger badge-pill ms-2">New</span></a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link page-scroll dropdown-toggle" href="/site/#" id="navbarBlogPage" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu submenu" aria-labelledby="navbarBlogPage">
                            <a class="dropdown-item" href="/site/blog-default.html">Blog Grid</a>
                            <a class="dropdown-item" href="/site/blog-left-sidebar.html">Blog Left Sidebar</a>
                            <a class="dropdown-item" href="/site/blog-single-right-sidebar.html">Details Right Sidebar</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="/site/#team">Team</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="/site/#contact">Contact</a>
                    </li>
            ...
            <div class="row align-items-center justify-content-between py-5">
                <div class="col-md-7 col-lg-6 col-xl-5">
                    <div class="hero-content-left text-white">
                        <h1 class="text-white fw-bold">Brainstorming for Desired Usability</h1>
                        <p class="lead">
                        ...
                        <div class="video-promo-content py-4 d-flex align-items-center">
                            <a href="/site/https://www.youtube.com/watch?v=9No-FiEInLA"
                               class="popup-youtube video-play-icon-without-bip video-play-icon me-3"><span class="ti-control-play"></span></a> Watch Video Overview
                ...
                <div class="col-md-5 col-lg-5">
                    <div class="hero-animation-img">
                        <img src="/site/img/app-product.png" alt="app" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        <div class="bottom-img-absolute">
            <img src="/site/img/hero-bg-shape-1.svg" alt="wave shape" class="img-fluid">
        </div>
    </section>
    <!--hero section end-->
                ...
                <div class="row align-items-center justify-content-between">
                        ...
                        <div class="about-content-left section-heading">
                            ...
                            <div class="single-feature mb-4 mt-5">
                                <div class="icon-box-wrap d-flex align-items-center mb-2">
                                    <div class="me-3 icon-box">
                                        <img src="/site/img/image-icon-1.png" alt="icon image" class="img-fluid">
                                    </div>
                            ...
                            <div class="single-feature mb-4">
                                <div class="icon-box-wrap mb-2">
                                    <div class="me-3 icon-box">
                                        <img src="/site/img/image-icon-2.png" alt="icon image" class="img-fluid">
                                    </div>
                            ...
                            <div class="single-feature mb-4">
                                <div class="icon-box-wrap mb-2">
                                    <div class="me-3 icon-box">
                                        <img src="/site/img/image-icon-3.png" alt="icon image" class="img-fluid">
                                    </div>
                            ...
                            <div class="single-feature mb-4">
                                <div class="icon-box-wrap mb-2">
                                    <div class="me-3 icon-box">
                                        <img src="/site/img/image-icon-4.png" alt="icon image" class="img-fluid">
                                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="about-content-right">
                            <img src="/site/img/image-11.png" alt="about us" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4 align-items-center justify-content-between">
                <div class="col-md-4">
                    <div class="download-img">
                        <img src="/site/img/image-14.png" alt="download" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="feature-contents section-heading">
                        <h2>Share your Photos with <br>
                            Friends Easily</h2>
                        ...
                        <ul class="list-inline mt-5">
                            <li class="list-inline-item">
                                <div class="me-3 icon-box border">
                                    <img src="/site/img/image-icon-2.png" alt="icon image" class="img-fluid">
                                </div>
                            </li>
                            <li class="list-inline-item">
                ...
                <div class="col-md-7">
                    <div class="download-content text-white pb-100">
                        ...
                        <div class="download-btn">
                            <a href="/site/#" class="btn google-play-btn me-3"><span class="ti-android"></span> Google
                                Play</a>
                            <a href="/site/#" class="btn app-store-btn"><span class="ti-apple"></span> App Store</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="download-img d-flex align-items-end">
                        <img src="/site/img/app-hand-top.png" alt="download" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <section id="pricing" class="package-section background-shape-right ptb-100">
            <div class="container">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card text-center single-pricing-pack p-5">
                            ...
                            <div class="pricing-img mt-3 mb-4">
                                <img src="/site/img/basic.svg" alt="pricing img" class="img-fluid">
                            </div>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="py-4 border-0 pricing-header">
                                    <div class="h1 text-center mb-0 color-secondary">$<span class="price fw-semibold">29</span></div>
                                </div>
                                <a href="/site/#" class="btn outline-btn" target="_blank">Purchase now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="card text-center popular-price single-pricing-pack p-5">
                            ...
                            <div class="pricing-img mt-3 mb-4">
                                <img src="/site/img/standard.svg" alt="pricing img" class="img-fluid">
                            </div>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="py-4 border-0 pricing-header">
                                    <div class="h1 text-center mb-0 color-secondary">$<span class="price fw-semibold">145</span></div>
                                </div>
                                <a href="/site/#" class="btn solid-btn" target="_blank">Purchase now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="card text-center single-pricing-pack p-5">
                            ...
                            <div class="pricing-img mt-3 mb-4">
                                <img src="/site/img/unlimited.svg" alt="pricing img" class="img-fluid">
                            </div>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="py-4 border-0 pricing-header">
                                    <div class="h1 text-center mb-0 color-secondary">$<span class="price fw-semibold">249</span></div>
                                </div>
                                <a href="/site/#" class="btn outline-btn" target="_blank">Purchase now</a>
                            </div>
                        </div>
                ...
                <div class="mt-5 text-center">
                    <p class="mb-2">If you need custom services or Need more? <a href="/site/#" class="color-secondary">
                        Contact us
                    </a></p>
                </div>
                <!--pricing faq start-->
                <div class="row mt-5">
                    <div class="col-lg-6">
                        <div id="accordion-1" class="accordion accordion-faq">
                            ...
                            <div class="card accordion-item">
                                <div class="card-header accordion-header py-4" id="heading-1-1" data-bs-toggle="collapse" role="button"
                                     data-bs-target="#collapse-1-1" aria-expanded="false" aria-controls="collapse-1-1">
                                    <h6 class="mb-0"><span class="ti-receipt me-3 color-secondary"></span> Which license do I need?</h6>
                                </div>
                            ...
                            <!-- Accordion card 2 -->
                            <div class="card accordion-item">
                                <div class="card-header py-4 accordion-header" id="heading-1-2" data-bs-toggle="collapse" role="button"
                                     data-bs-target="#collapse-1-2" aria-expanded="false" aria-controls="collapse-1-2">
                                    <h6 class="mb-0"><span class="ti-gallery me-3 color-secondary"></span> How do I get access to a theme?</h6>
                                </div>
                            ...
                            <!-- Accordion card 3 -->
                            <div class="card accordion-item">
                                <div class="card-header py-4 accordion-header" id="heading-1-3" data-bs-toggle="collapse" role="button"
                                     data-bs-target="#collapse-1-3" aria-expanded="false" aria-controls="collapse-1-3">
                                    <h6 class="mb-0"><span class="ti-wallet me-3 color-secondary"></span> How do I see previous orders?
                                    </h6>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div id="accordion-2" class="accordion accordion-faq">
                            <!-- Accordion card 1 -->
                            <div class="card accordion-item">
                                <div class="card-header py-4 accordion-header" id="heading-2-1" data-bs-toggle="collapse" role="button"
                            ...
                            <!-- Accordion card 2 -->
                            <div class="card accordion-item">
                                <div class="card-header py-4 accordion-header" id="heading-2-2" data-bs-toggle="collapse" role="button"
                                     data-bs-target="#collapse-2-2" aria-expanded="false" aria-controls="collapse-2-2">
                                    <h6 class="mb-0"><span class="ti-lock me-3 color-secondary"></span> How do I get access to a theme?</h6>
                                </div>
                            ...
                            <!-- Accordion card 3 -->
                            <div class="card accordion-item">
                                <div class="card-header py-4 accordion-header" id="heading-2-3" data-bs-toggle="collapse" role="button"
                                     data-bs-target="#collapse-2-3" aria-expanded="false" aria-controls="collapse-2-3">
                                    <h6 class="mb-0"><span class="ti-widget me-3 color-secondary"></span> How do I see previous orders?
                                    </h6>
                                </div>
                    ...
                    <div class="section-heading mb-5">
                        ...
                        <div class="client-section-wrap d-flex flex-row align-items-center">
                            <ul class="list-inline">
                                <li class="list-inline-item"><img src="/site/img/client-1-color.png" width="85" alt="client"
                                                                  class="img-fluid"></li>
                                <li class="list-inline-item"><img src="/site/img/client-6-color.png" width="85" alt="client"
                                                                  class="img-fluid"></li>
                                <li class="list-inline-item"><img src="/site/img/client-3-color.png" width="85" alt="client"
                                                                  class="img-fluid"></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="testimonial-quote-wrap">
                                <div class="media author-info mb-3">
                                    <div class="author-img me-3">
                                        <img src="/site/img/client-1.jpg" alt="client" class="img-fluid rounded-circle">
                                    </div>
                                ...
                                <div class="client-say">
                                    <p> <img src="/site/img/quote.png" alt="quote" class="img-fluid"> Interactively optimize fully researched expertise vis-a-vis plug-and-play relationships. Intrinsicly develop viral core competencies for fully tested customer service. Enthusiastically create next-generation growth strategies and.</p>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="testimonial-quote-wrap">
                                <div class="media author-info mb-3">
                                    <div class="author-img me-3">
                                        <img src="/site/img/client-2.jpg" alt="client" class="img-fluid rounded-circle">
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="client-say">
                                    <p><img src="/site/img/quote.png" alt="quote" class="img-fluid">  Rapidiously develop user friendly growth strategies after extensive initiatives. Conveniently grow innovative benefits through fully tested deliverables. Rapidiously utilize focused platforms through end-to-end schemas.</p>
                                </div>
                            </div>
                        </div>
                        <div class="item">
        ...
        <div class="container">
            ...
            <div class="screen-slider-content mt-5">
                ...
                <div class="screen-carousel owl-carousel owl-theme dot-indicator">
                    <img src="/site/img/01.png" class="img-fluid" alt="screenshots">
                    <img src="/site/img/02.png" class="img-fluid" alt="screenshots">
                    <img src="/site/img/03.png" class="img-fluid" alt="screenshots">
                    <img src="/site/img/04.png" class="img-fluid" alt="screenshots">
                    <img src="/site/img/05.png" class="img-fluid" alt="screenshots">
                    <img src="/site/img/06.png" class="img-fluid" alt="screenshots">
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-team-member position-relative">
                        <div class="team-image">
                            <img src="/site/img/team-4.jpg" alt="Team Members" class="img-fluid rounded-circle">
                        </div>
                        <div class="team-info text-white rounded-circle d-flex flex-column align-items-center justify-content-center">
                            ...
                            <ul class="list-inline team-social social-icon mt-4 text-white">
                                <li class="list-inline-item"><a href="/site/#"><span class="ti-facebook"></span></a></li>
                                <li class="list-inline-item"><a href="/site/#"><span class="ti-twitter"></span></a></li>
                                <li class="list-inline-item"><a href="/site/#"><span class="ti-github"></span></a></li>
                                <li class="list-inline-item"><a href="/site/#"><span class="ti-dribbble"></span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single-team-member position-relative">
                        <div class="team-image">
                            <img src="/site/img/team-1.jpg" alt="Team Members" class="img-fluid rounded-circle">
                        </div>
                        <div class="team-info text-white rounded-circle d-flex flex-column align-items-center justify-content-center">
                            <h5 class="mb-0">Edna Mason</h5>
                            <h6>Senior Designer</h6>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-team-member position-relative">
                        <div class="team-image">
                            <img src="/site/img/team-2.jpg" alt="Team Members" class="img-fluid rounded-circle">
                        </div>
                        <div class="team-info text-white rounded-circle d-flex flex-column align-items-center justify-content-center">
                            <h5 class="mb-0">Edna Mason</h5>
                            <h6>Senior Designer</h6>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-team-member position-relative">
                        <div class="team-image">
                            <img src="/site/img/team-3.jpg" alt="Team Members" class="img-fluid rounded-circle">
                        </div>
                        <div class="team-info text-white rounded-circle d-flex flex-column align-items-center justify-content-center">
                            <h5 class="mb-0">Edna Mason</h5>
                            <h6>Senior Designer</h6>
                ...
                <div class="col-md-8">
                    <div class="section-heading mb-5">
                        ...
                        <p class="lead">
                            ...
                            transform tactical methods of resource sucking core.
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-xl-4">
                    <div class="single-blog-card card border-0 shadow-sm">
                        ...
                        <img src="/site/img/blog/1.jpg" class="card-img-top position-relative" alt="blog">
                        <div class="card-body">
                            ...
                            <h3 class="h5 card-title"><a href="/site/#">Appropriately productize fully</a></h3>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk.</p>
                            <a href="/site/#" class="detail-link">Read more <span class="ti-arrow-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="single-blog-card card border-0 shadow-sm">
                        ...
                        <img src="/site/img/blog/2.jpg" class="card-img-top position-relative" alt="blog">
                        <div class="card-body">
                            <div class="post-meta mb-2">
                                <ul class="list-inline meta-list">
                            ...
                            <h3 class="h5 card-title"><a href="/site/#">Quickly formulate backend</a></h3>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="single-blog-card card border-0 shadow-sm">
                        <span class="category position-absolute badge badge-pill text-white bg-info">Science</span>
                        <img src="/site/img/blog/3.jpg" class="card-img-top" alt="blog">
                        <div class="card-body">
                            <div class="post-meta mb-2">
                                <ul class="list-inline meta-list">
                            ...
                            <h3 class="h5 card-title"><a href="/site/#">Objectively extend extensive</a></h3>
                ...
                <div class="col-md-5">
                    ...
                    <div class="footer-address">
                        ...
                        <ul>
                            ...
                            <li><span>Email : <a href="/site/mailto:hello@yourdomain.com">hello@yourdomain.com</a></span>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-7">
                    <form action="#" method="POST" id="contactForm" class="contact-us-form" novalidate="novalidate">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    <textarea name="message" id="message" class="form-control h-100" rows="7" cols="25"
                ...
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme clients-carousel dot-indicator">
                        <div class="item single-client">
                            <img src="/site/img/client-5-color.png" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="/site/img/client-1-color.png" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="/site/img/client-6-color.png" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="/site/img/client-3-color.png" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="/site/img/client-4-color.png" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="/site/img/client-5-color.png" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="/site/img/client-7-color.png" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="/site/img/client-2-color.png" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="/site/img/client-1-color.png" alt="client logo" class="client-img">
                        </div>
...
<div class="shape-img subscribe-wrap">
    <img src="/site/img/footer-top-shape.png" alt="footer shape" class="img-fluid">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
            ...
            <div class="row justify-content-between">
                <div class="col-md-12 col-lg-4 mb-4 mb-md-4 mb-sm-4 mb-lg-0">
                    <div class="footer-nav-wrap text-white">
                        <img src="/site/img/logo-white-1x.png" alt="footer logo" width="120" class="img-fluid mb-3">
                        ...
                        <div class="social-list-wrap">
                            <ul class="social-list list-inline list-unstyled">
                                <li class="list-inline-item"><a href="/site/#" target="_blank" title="Facebook"><span
                                        class="ti-facebook"></span></a></li>
                                <li class="list-inline-item"><a href="/site/#" target="_blank" title="Twitter"><span
                                        class="ti-twitter"></span></a></li>
                                <li class="list-inline-item"><a href="/site/#" target="_blank"
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 mb-4 mb-sm-4 mb-md-0 mb-lg-0">
                            <div class="footer-nav-wrap text-white">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><a href="/site/#">Help</a></li>
                                    <li class="mb-2"><a href="/site/#">Events</a></li>
                                    <li class="mb-2"><a href="/site/#">Live Support</a></li>
                                    <li class="mb-2"><a href="/site/#">Open Sources</a></li>
                                    <li class="mb-2"><a href="/site/#">Documentation</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-4 mb-4 mb-sm-4 mb-md-0 mb-lg-0">
                            <div class="footer-nav-wrap text-white">
                                ...
                                <ul class="list-unstyled support-list">
                                    <li class="mb-2">
                                        <a href="/site/#">About Us</a>
                                    </li>
                                    <li class="mb-2">
                                        <a href="/site/#">Careers</a>
                                    </li>
                                    <li class="mb-2">
                                        <a href="/site/#">Customers</a>
                                    </li>
                                    <li class="mb-2">
                                        <a href="/site/#">Community</a>
                                    </li>
                                    <li class="mb-2">
                                        <a href="/site/#">Our Team</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-5">
                        <div class="terms-policy-wrap text-md-end text-start">
                            <ul class="list-inline">
                                <li class="list-inline-item"><a class="small-text" href="/site/#">Terms</a></li>
                                <li class="list-inline-item"><a class="small-text" href="/site/#">Security</a></li>
                                <li class="list-inline-item"><a class="small-text" href="/site/#">Privacy Policy</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<!--validator js-->
<script src="/site/js/validator.min.js"></script>
<!--custom js-->
